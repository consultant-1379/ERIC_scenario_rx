...
import static com.ericsson.de.scenariorx.impl.graph.VertexTypeResolver.resolveVertexTypeName;
...
import com.ericsson.de.scenariorx.impl.graph.jgrapht.AttributeProvider;
import com.ericsson.de.scenariorx.impl.graph.jgrapht.SuperGraphMLExporter;
...
public class GraphMlExporter extends AbstractGraphExporter {
    ...
    @Override
    protected void init() {
        List<AttributeProvider<GraphNode>> vertexAttributeProviders = asList(
                new AttributeProvider<GraphNode>(GraphNode.Attributes.NAME) {
                    @Override
