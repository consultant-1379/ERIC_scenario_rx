 ...
 */
public class RxBasicDataRecord implements RxDataRecord {
    /**
     ...
     * @return builder for BasicDataRecord
     */
    public static DataRecordBuilder copy(RxDataRecord record) {
     ...
     * @return Data Record
     */
    public static RxDataRecord fromMap(Map<String, Object> values) {
        return new RxBasicDataRecord(values);
    }
     ...
     * @return Data Record
     */
    public static RxDataRecord fromValues(Object... nameValues) {
        return new RxBasicDataRecord(nameValues);
    }

    private final Map<String, Object> values = Maps.newHashMap();

    private RxBasicDataRecord(Map<String, Object> values) {
        this.values.putAll(values);
    }

    private RxBasicDataRecord(Object... nameValues) {
    ...
    public static final class DataRecordBuilder {
        ...
        DataRecordBuilder(RxDataRecord record) {
         ...
         * @return the builder
         */
        public DataRecordBuilder setFields(RxDataRecord... records) {
            for (RxDataRecord dataRecord : records) {
         ...
         */
        public RxDataRecord build() {
            return build(RxDataRecord.class);
        }

        /**
         * Build the DataRecord
         *
         * @param type subclass of DataRecord representing Data Record fields as getters of Java Bean
         * @return a DataRecord which contains the fields set in the Builder
         */
        public <T extends RxDataRecord> T build(final Class<T> type) {
            DefaultDataRecordTransformer<T> defaultDataRecordTransformer = new DefaultDataRecordTransformer<>();
            checkArgument(
                    defaultDataRecordTransformer.canTransformTo(type),
                    "Unable to convert to " + type.getSimpleName() + ", as it does not subclass of"
                            + " com.ericsson.de.scenariorx.api.DataRecord");
            return defaultDataRecordTransformer.transform(new RxBasicDataRecord(data), type);
        }
    }
}
