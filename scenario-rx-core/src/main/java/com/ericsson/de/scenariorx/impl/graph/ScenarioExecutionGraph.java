...
public class ScenarioExecutionGraph extends DefaultDirectedGraph<ScenarioExecutionGraph.GraphNode, ScenarioExecutionGraph.LabeledEdge> {
    ...
    public static class RootNode extends GraphNode {
        ...
        private static final String SCENARIO_STARTED = "Scenario started";
    ...
    public static class SubFlowNode extends FlowNode {
        ...
        SubFlowNode(String id, String name,
                    String dataRecord, String vUser, String meta,
                    String exceptionName, Throwable exception) {
    ...
    public static class FlowEndedNode extends FlowNode {
        ...
        FlowEndedNode(String id, String name,
                      String dataRecord, String vUser, String meta,
                      String exceptionName, Throwable exception) {
            super(id, name, dataRecord, vUser, meta, exceptionName, exception);
        }
    ...
    public static class TestStepNode extends GraphNode {
        TestStepNode(String id, String name,
    ...
    public static class ScenarioFinishedNode extends GraphNode {
        ...
        private static final String SCENARIO_FINISHED = "Scenario finished";
    ...
    public static abstract class GraphNode {
        ...
        GraphNode(String id, String name,
                  String vUser, String meta, String dataRecord, String status,
                  String exceptionName, Throwable exception) {
            this.id = id;
            this.name = name;
            this.vUser = vUser;
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(id, graphNode.id) &&
                    Objects.equals(dataRecord, graphNode.dataRecord) &&
                    Objects.equals(vUser, graphNode.vUser) &&
                    Objects.equals(meta, graphNode.meta) &&
                    Objects.equals(exceptionName, graphNode.exceptionName);
        }
