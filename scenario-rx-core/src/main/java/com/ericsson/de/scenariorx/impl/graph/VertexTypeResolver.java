...
public final class VertexTypeResolver {
    ...
    enum VertexType {
        ...
        ROOT(ScenarioExecutionGraph.RootNode.class),
        SUB_FLOW(ScenarioExecutionGraph.SubFlowNode.class),
        TEST_STEP(ScenarioExecutionGraph.TestStepNode.class),
        FLOW_ENDED(ScenarioExecutionGraph.FlowEndedNode.class),
        SCENARIO_FINISHED(ScenarioExecutionGraph.ScenarioFinishedNode.class);
