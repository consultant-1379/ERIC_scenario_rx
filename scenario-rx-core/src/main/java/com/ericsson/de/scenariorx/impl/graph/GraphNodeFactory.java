package com.ericsson.de.scenariorx.impl.graph;

import static com.ericsson.de.scenariorx.impl.graph.VertexTypeResolver.resolveVertexType;
...
import com.ericsson.de.scenariorx.impl.graph.VertexTypeResolver.VertexType;
...
public final class GraphNodeFactory {
    ...
    public static SubFlowNode createSubFlowNode(String id, String name,
                                                String dataRecord, String vUser,
                                                String meta, String exceptionName) {
        return createSubFlowNode(id, name, dataRecord, vUser, meta, exceptionName, null);
    }

    public static TestStepNode createTestStepNode(String id, String name,
                                                  Long startTime, Long endTime,
                                                  String dataRecord, String vUser, String meta,
    ...
    public static FlowEndedNode createFlowEndedNode(String id, String name,
                                                    String dataRecord, String vUser,
                                                    String meta, String exceptionName) {
    ...
    public static SubFlowNode createSubFlowNode(String id, String name,
                                                String dataRecord, String vUser,
                                                String meta, Throwable exception) {
    ...
    public static TestStepNode createTestStepNode(String id, String name,
                                                  Long startTime, Long endTime,
                                                  String dataRecord, String vUser, String meta, String status,
                                                  String exceptionName, Throwable exception) {
