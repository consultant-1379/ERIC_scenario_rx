...
/**
 * Parses JSON output produced by {@link com.ericsson.de.scenariorx.impl.DataRecords} children {@code toString()}
...
public class DataRecordsJsonParser {
     ...
     * @param dataRecord The DataRecord to be parsed
     * @return Parsed Map
     */
    public Map<String, RxDataRecord> parseDataRecords(String dataRecord) {
        Map<String, RxDataRecord> dataRecords = newLinkedHashMap();
    ...
    private void parseNode(Map<String, RxDataRecord> dataRecords, JsonNode node) {
        if (node.isArray()) {
    ...
    private void parseArray(Map<String, RxDataRecord> dataRecords, JsonNode array) {
    ...
    private void parseObject(Map<String, RxDataRecord> dataRecords, JsonNode object) {
        ...
        if (dataSource.hasNext()) {
            ...
            if (records.hasNext()) {
                ...
                dataRecords.put(dataSourceName, RxBasicDataRecord.fromMap(recordMap));
            }
        }
    }
}
