...
import static com.ericsson.de.scenariorx.impl.StackTraceFilter.RX_API;
import static com.ericsson.de.scenariorx.impl.StackTraceFilter.RX_SCENARIO_RUNNER;
...
import static com.ericsson.de.scenariorx.impl.StackTraceFilter.filterTestwareStackTrace;
import static com.ericsson.de.scenariorx.impl.StackTraceFilter.getStackTraceLimit;
...
public class StackTraceFilterTest {
    ...
    public void filterTestwareStackTrace_shouldRemove_rxScenario() throws Exception {
        prepareStackTrace(
                Api.class.getName(),
                "foo",
                "com.ericsson.de.scenariorx.impl.Foo",
                "bar",
                Implementation.class.getName(),
                "baz",
                "com.ericsson.de.scenariorx.impl.Bar",
                "qux"
        );
    ...
    public void getStackTraceLimit_withRunnerAndRxApiImpl() throws Exception {
        ...
        assertThatLimitForStackTrace("foo", RX_SCENARIO_RUNNER, RX_API, "com.testware.Test1", "com.testware.Test2", "com.runner.TestRunner").isEqualTo(5);
    }
