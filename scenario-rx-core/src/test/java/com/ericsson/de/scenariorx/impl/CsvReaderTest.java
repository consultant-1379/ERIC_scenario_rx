...
public class CsvReaderTest {
    ...
    public void read_csvDataRecord() {
        List<RxDataRecord> dataRecords = CsvReader.read(CSV);
    ...
    public void read_CsvWithSpecialCharacters(){
        List<RxDataRecord> dataRecords = CsvReader.read(CSV_WITH_SPECIAL_CHARACTERS);
        assertThat(dataRecords).hasSize(2);
        for(RxDataRecord dataRecord: dataRecords){
    ...
    public void read_csvWithQuotes() {
        List<RxDataRecord> dataRecords = CsvReader.read(CSV_WITH_QUOTES);
    ...
    public void read_csvWithEmptyValue() {
        List<RxDataRecord> dataRecords = CsvReader.read(CSV_WITH_EMPTY_VALUE);
    ...
    public void read_mixQuoted() {
        List<RxDataRecord> dataRecords = CsvReader.read(CSV_WITH_MIX_QUOTED);
    ...
    public void read_commentedOutRows(){
        List<RxDataRecord> dataRecords = CsvReader.read(CSV_WITH_COMMENTED_ROWS);
